...
do
    ...
    # safety gym
    sbatch seuss_sbatch_curriculum_single.sh ${i} 0099_point_push2_curr_lr5e-2_decrease0.5_init_512_stable_10_target_d_25 0.05
    # sbatch seuss_sbatch_curriculum_single.sh ${i} 0099_point_push2_curr_lr1e-2_decrease0.5_init_512_stable_10_target_d_25_clip_penalty 0.01
    # sbatch seuss_sbatch_curriculum_single.sh ${i} 0099_point_push2_curr_lr1e-1_decrease0.5_init_512_stable_10_target_d_25_clip_penalty 0.1
        # No curriculum
    sbatch seuss_sbatch_no_curriculum_single.sh ${i} 0099_point_push2_no_curr_steps_30k_penalty_lr_5e-2 0.05
    sbatch seuss_sbatch_no_curriculum_single.sh ${i} 0099_point_push2_no_curr_steps_30k_penalty_lr_1e-2 0.01
    sbatch seuss_sbatch_no_curriculum_single.sh ${i} 0099_point_push2_no_curr_steps_30k_penalty_lr_1e-1 0.1

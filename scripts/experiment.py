...
def main(robot, task, algo, seed, exp_name, cpu, init_cost_lim, target_cost_lim, curriculum, decrease_ratio, stable_length, penalty_lr, clip_penalty):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--clip_penalty', action='store_true', default=False,
                        help='The method that the penalty will never decrease')
    ...
    stable_length=args.stable_length, penalty_lr=args.penalty_lr, clip_penalty=args.clip_penalty)